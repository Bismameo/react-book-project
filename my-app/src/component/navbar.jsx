        ...
        <div className="black-wrap">
          ...
          <div className="black-section">
            ...
            <div className={`black-right${menuOpen ? ' show' : ''}`}>
              ...
              <Link className="black-cart" to="/cart" onClick={handleCartClick}>
              ...
              {user ? (
                <div className="black-auth-btn" onClick={handleLogout}>
                  <FaSignOutAlt size={14} />
                  Sign Out
                </div>
              ) : (
                <>
                  <Link className="black-auth-btn" to="/login" onClick={closeMenu}>
                    <FaSignInAlt size={14} />
                    Login
                  </Link>
                  <Link className="black-auth-btn" to="/signup" onClick={closeMenu}>
                    <FaUserPlus size={14} />
                    Sign Up
                  </Link>
                </>
